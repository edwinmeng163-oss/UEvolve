...
namespace UnrealMcp
{
	...
	const TArray<FToolHandlerRegistryEntry>& GetToolHandlerRegistryEntries()
	{
		static const TArray<FToolHandlerRegistryEntry> Entries = {
			...
			MakeHandlerEntry(TEXT("unreal.editor_status"), TEXT("editor")),
			MakeHandlerEntry(TEXT("unreal.execute_console_command"), TEXT("editor")),
			MakeHandlerEntry(TEXT("unreal.execute_python"), TEXT("editor")),
			MakeHandlerEntry(TEXT("unreal.execute_python_file"), TEXT("editor")),
			MakeHandlerEntry(TEXT("unreal.layout_actors_circle"), TEXT("actors")),
			MakeHandlerEntry(TEXT("unreal.layout_actors_grid"), TEXT("actors")),
			MakeHandlerEntry(TEXT("unreal.list_assets"), TEXT("editor")),
			MakeHandlerEntry(TEXT("unreal.list_level_actors"), TEXT("actors")),
			MakeHandlerEntry(TEXT("unreal.list_maps"), TEXT("editor")),
			MakeHandlerEntry(TEXT("unreal.list_selected_actors"), TEXT("actors")),
			MakeHandlerEntry(TEXT("unreal.list_selected_assets"), TEXT("editor")),
			MakeHandlerEntry(TEXT("unreal.map_check"), TEXT("editor")),
			...
			MakeHandlerEntry(TEXT("unreal.open_asset"), TEXT("editor")),
			MakeHandlerEntry(TEXT("unreal.open_map"), TEXT("editor")),
			...
			MakeHandlerEntry(TEXT("unreal.save_dirty_packages"), TEXT("editor")),
			...
			MakeHandlerEntry(TEXT("unreal.select_actors"), TEXT("actors")),
			...
			MakeHandlerEntry(TEXT("unreal.start_pie"), TEXT("editor")),
			MakeHandlerEntry(TEXT("unreal.stop_pie"), TEXT("editor")),
			MakeHandlerEntry(TEXT("unreal.sync_content_browser"), TEXT("editor")),
			MakeHandlerEntry(TEXT("unreal.tail_log"), TEXT("editor")),
