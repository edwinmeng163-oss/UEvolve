...
- `Private/Tools/Actors`: actor selection, transforms, spawning, layout, batch edits. The read/query selection tools `unreal.list_level_actors`, `unreal.list_selected_actors`, and `unreal.select_actors` now live in `UnrealMcpActorTools.cpp`.
