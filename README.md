...
- 123 registered MCP tools across actors, blueprint, editor, memory, scaffold, self-extension, skills, and widget categories.
...
- 已注册 123 个 MCP tools，覆盖 actors、blueprint、editor、memory、scaffold、self-extension、skills、widget 分类。
...
- actors、blueprint、editor、memory、scaffold、self-extension、skills、widget カテゴリにまたがる 123 個の MCP tools を登録済みです。
